...
/**
 * Frees a stage0 struct. Since musig_stage1 frees its stage0 input, this should only be used if the MuSig session is aborted for an external reason.
 */
void musig_free_stage0(stage0 * stage0);
/**
 * Frees a stage1 struct. Since musig_stage2 frees its stage1 input, this should only be used if the MuSig session is aborted for an external reason.
 */
void musig_free_stage1(stage1 * stage1);
/**
 * Frees a stage2 struct. Since musig_stage3 frees its stage2 input, this should only be used if the MuSig session is aborted for an external reason.
